...
| Backend API | ✅ Full CRUD + RICE/ICE/MoSCoW/ValueEffort scoring + item tags + completion + history log + Notion & Linear export (114 pytest tests) |
...
| Testing  | pytest (114 tests, backend), Playwright (5 e2e scenarios)  |
